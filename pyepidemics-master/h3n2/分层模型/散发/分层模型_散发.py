...
class ObjectiveWeights:
    ...
    omega1: float = 1.20
    omega2: float = 10.00  # 场景自適应：散发激进，优化感染率
    lambda_AR: float = 8.00  # 场景自適应：散发激进，潮前消露
    lambda_P: float = 0.10
...
class CostWeights:
    ...
    c_o: float = 2.00
    c_vax: float = 8.0
    c_q: float = 2.50  # 场景自適应：散发激进，涉需积極隔离
    c_q2: float = 0.15  # 场景自適应：散发激进
...
class DisruptionWeights:
    ...
    d_q_load: float = 18.00  # 场景自適应：散发激进，潮前消需
